...
This suggests an alternative understanding of evolution, where species undergo _natural drift_ (autopoietic optimisation) rather than selection (adaptation to environment). In _The Embodied Mind_, these principles are also extended to psychology through the Buddhist concept of Karma. Far from the vernacular usage of the term where it relates fate, in Buddhist tradition, karma relates to a form of psychological causality: how one experiential state leads to another, and how to break free from these causal chains through mindfulness.
